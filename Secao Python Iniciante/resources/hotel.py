...
class Hotel(Resource):
    ...
    argumentos.add_argument('site_id', type=int, required=True, help="Every hotel needs to be linked wih site")
    ...
    def put(self, hotel_id):
        ...
        if hotel_encontrado: #Conferindo se o hotel existe
    ...
    def delete(self, hotel_id):
        hotel = Hotel
        HotelModel.find_hotel(hotel_id)
        if hotel:
